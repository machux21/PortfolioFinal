...
export const iconStyle = { width: "60px", height: "60px", margin: "10px" };

const About = () => {
	return (
		<Box sx={{position: "relative", display: "flex", justifyContent: "center", flexDirection: "column", mt: 12}}>
		<Box sx={{position: "relative", margin: "0 auto"}}>
			...
			>
				...
				>
					...
					movie The Social Network. I was interested in how a single
